...
-- Add foreign keys to user_address
ALTER TABLE user_address
ADD CONSTRAINT fk_user_address_user
FOREIGN KEY (user_id) REFERENCES users(id)
ON DELETE CASCADE;

-- Add foreign keys to user_payment
ALTER TABLE user_payment
ADD CONSTRAINT fk_user_payment_user
FOREIGN KEY (user_id) REFERENCES users(id)
ON DELETE CASCADE;

-- Add foreign keys to admin_user
...
-- Add foreign keys to shopping_session
ALTER TABLE shopping_session
ADD CONSTRAINT fk_shopping_session_user
FOREIGN KEY (user_id) REFERENCES users(id)
ON DELETE CASCADE;

-- Add foreign keys to cart_item
...
-- Add foreign keys to payment_details
